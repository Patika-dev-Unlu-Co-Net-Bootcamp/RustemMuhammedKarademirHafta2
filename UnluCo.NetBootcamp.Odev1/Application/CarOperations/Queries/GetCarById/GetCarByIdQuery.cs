...
namespace UnluCo.NetBootcamp.Odev2.Application.CarOperations.Queries.GetCarById
{
    public class GetCarByIdQuery
    {
        ...
        {
            var car = _dbContext.Cars.Include(x => x.Brand).Where(x => x.IsActive).SingleOrDefault(x => x.CarId == carId);//CarSystemDbContext altinda tanimli Cars listesinde carId ile eslesen ve IsActive degeri true olan kayit var mi diye kontrol eder.
            if (car is null)
